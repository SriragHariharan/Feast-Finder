    ...
    <div className='w-full md:w-9/12 xl:w-6/12 mx-auto'>
        ...
        <div className='flex justify-between p-4'>
            <div className='text-left'>
                <p className='font-semibold text-sm mb-3 md:text-3xl'>{restaurantDetails?.name}</p>
        ...
        <div className='flex mt-2 m-4'>
            ...
            <p className='text-xs md:text-lg font-medium ml-2 mr-8'>Below 20 MINS</p>
            
            <i className="text-xs md:text-lg fa-solid fa-indian-rupee-sign mt-1"></i>
            <p className='text-xs md:text-lg font-medium ml-2 '>{restaurantDetails?.costForTwoMessage}</p>
        </div>
